...
export const Reports = () => {
    ...
    const { canUseReports, isLoading: planLoading } = usePlanFeatures(coachingId);
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            {(!canUseReports && !planLoading) ? (
                <div className="flex flex-col items-center justify-center py-20 bg-white rounded-3xl border border-dashed border-gray-200 p-12 text-center">
                    <div className="w-16 h-16 bg-amber-50 rounded-2xl flex items-center justify-center mb-6">
                        <Lock className="w-8 h-8 text-amber-600" />
                    </div>
                    <h2 className="text-2xl font-bold text-gray-900 mb-3">Analytics are Locked</h2>
                    <p className="text-gray-600 max-w-md mx-auto mb-8">
                        Detailed reporting and performance insights are available on the **Advanced** and **Pro** plans. Upgrade to unlock data-driven growth.
                    </p>
                    <Link
                        to="/admin/dashboard/settings/plans"
                        className="px-8 py-3 bg-gradient-to-r from-amber-500 to-orange-600 text-white rounded-xl font-bold shadow-lg shadow-amber-200 hover:shadow-xl hover:translate-y-[-2px] transition-all"
                    >
                ...
                <>
                    ...
                    {/* (I will provide the full content here to be safe) */}
